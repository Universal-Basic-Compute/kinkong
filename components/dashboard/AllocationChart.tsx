...
const INITIAL_TOKEN_METADATA: Record<string, { name: string; token: string; image?: string }> = {
...
export function AllocationChart() {
  ...
  const [tokenMetadata, setTokenMetadata] = useState<Record<string, { name: string; token: string; image?: string }>>(INITIAL_TOKEN_METADATA);
